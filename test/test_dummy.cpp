...
main(int argc, char *argv[])
{
    ...
    mythread a(qrt::this_cpu::get_cycles(), qrt::this_cpu::get_cycles() + sec * 10, 1);
    mythread b(qrt::this_cpu::get_cycles(), qrt::this_cpu::get_cycles() + sec * 10, 2);
